...
public class HostListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		hosts[10] = new Host("nigger.cat", "https://nigger.cat/upload.php?output=gyazo", "50MiB", Host.Type.POMF);
		hosts[11] = new Host("p.fuwafuwa.moe", "https://p.fuwafuwa.moe/upload.php?output=gyazo", "128MiB", Host.Type.POMF);
		hosts[12] = new Host("pomf.nyafuu.org", "https://pomf.nyafuu.org/upload.php?output=gyazo", "50MiB", Host.Type.POMF);
		...
		hosts[17] = new Host("Uguu", "https://uguu.se/api.php?d=upload-tool", "100MiB, 24 hours", Host.Type.UGUU);
